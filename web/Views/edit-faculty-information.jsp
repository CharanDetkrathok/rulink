                        ...
                        <div class="form-group">
                            ...
                            <c:choose>
                                <c:when test="${DUPLICATE_NAME_ERROR == true}">
                                    ...
                                    <input type="text" class="form-control duplicate-error"  placeholder="Faculty name" name="fac_name" value="${fac.fac_Name}" required="true" style="border-color: red;">
                                </c:when>    
                                <c:otherwise>
                        ...
                        <div class="form-group">
                            ...
                            <c:choose>
                                <c:when test="${DUPLICATE_NUMBER_ERROR == true}">
                                    ...
                                    <input type="text" class="form-control duplicate-error" placeholder="Faculty No." name="fac_no" value="${fac.fac_No}" required="true" style="border-color: red;">
                                </c:when>    
                                <c:otherwise>
